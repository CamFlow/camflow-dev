...
static const char HK_STR_PTRACE_ACCESS_CHECK[] = "security_ptrace_access_check";
static const char HK_STR_PTRACE_TRACEME[] = "security_ptrace_traceme";
...
const char *relation_str(uint64_t type)
{
	...
	case HK_PTRACE_ACCESS_CHECK:
		return HK_STR_PTRACE_ACCESS_CHECK;
	case HK_PTRACE_TRACEME:
		return HK_STR_PTRACE_TRACEME;
	case HK_FILE_IOCTL:
...
uint64_t relation_id(const char *str)
{
	...
	MATCH_AND_RETURN(str, HK_STR_TASK_ALLOC, HK_TASK_ALLOC);
	MATCH_AND_RETURN(str, HK_STR_TASK_FREE, HK_TASK_FREE);
	MATCH_AND_RETURN(str, HK_STR_CRED_ALLOC_BLANK, HK_CRED_ALLOC_BLANK);
	MATCH_AND_RETURN(str, HK_STR_CRED_FREE, HK_CRED_FREE);
	MATCH_AND_RETURN(str, HK_STR_CRED_PREPARE, HK_CRED_PREPARE);
	MATCH_AND_RETURN(str, HK_STR_CRED_TRANSFER, HK_CRED_TRANSFER);
	MATCH_AND_RETURN(str, HK_STR_TASK_FIX_SETUID, HK_TASK_FIX_SETUID);
	MATCH_AND_RETURN(str, HK_STR_TASK_SETPGID, HK_TASK_SETPGID);
	MATCH_AND_RETURN(str, HK_STR_TASK_GETPGID, HK_TASK_GETPGID);
	MATCH_AND_RETURN(str, HK_STR_TASK_KILL, HK_TASK_KILL);
	...
	MATCH_AND_RETURN(str, HK_STR_INODE_CREATE, HK_INODE_CREATE);
	MATCH_AND_RETURN(str, HK_STR_INODE_PERMISSION, HK_INODE_PERMISSION);
	MATCH_AND_RETURN(str, HK_STR_INODE_LINK, HK_INODE_LINK);
	MATCH_AND_RETURN(str, HK_STR_INODE_UNLINK, HK_INODE_UNLINK);
	MATCH_AND_RETURN(str, HK_STR_INODE_SYMLINK, HK_INODE_SYMLINK);
	MATCH_AND_RETURN(str, HK_STR_INODE_RENAME, HK_INODE_RENAME);
	MATCH_AND_RETURN(str, HK_STR_INODE_SETATTR, HK_INODE_SETATTR);
	MATCH_AND_RETURN(str, HK_STR_INODE_GETATTR, HK_INODE_GETATTR);
	MATCH_AND_RETURN(str, HK_STR_INODE_READLINK, HK_INODE_READLINK);
	MATCH_AND_RETURN(str, HK_STR_INODE_SETXATTR, HK_INODE_SETXATTR);
	MATCH_AND_RETURN(str, HK_STR_INODE_POST_SETXATTR, HK_INODE_POST_SETXATTR);
	MATCH_AND_RETURN(str, HK_STR_INODE_GETXATTR, HK_INODE_GETXATTR);
	MATCH_AND_RETURN(str, HK_STR_INODE_LISTXATTR, HK_INODE_LISTXATTR);
	MATCH_AND_RETURN(str, HK_STR_INODE_REMOVEXATTR, HK_INODE_REMOVEXATTR);
	MATCH_AND_RETURN(str, HK_STR_INODE_GETSECURITY, HK_INODE_GETSECURITY);
	MATCH_AND_RETURN(str, HK_STR_INODE_LISTSECURITY, HK_INODE_LISTSECURITY);
	MATCH_AND_RETURN(str, HK_STR_FILE_PERMISSION, HK_FILE_PERMISSION);
	MATCH_AND_RETURN(str, HK_STR_FILE_SPLICE_PIPE_TO_PIPE, HK_FILE_SPLICE_PIPE_TO_PIPE);
	MATCH_AND_RETURN(str, HK_STR_KERNEL_READ_FILE, HK_KERNEL_READ_FILE);
	MATCH_AND_RETURN(str, HK_STR_FILE_OPEN, HK_FILE_OPEN);
	MATCH_AND_RETURN(str, HK_STR_FILE_RECEIVE, HK_FILE_RECEIVE);
	MATCH_AND_RETURN(str, HK_STR_FILE_LOCK, HK_FILE_LOCK);
	MATCH_AND_RETURN(str, HK_STR_FILE_SEND_SIGIOTASK, HK_FILE_SEND_SIGIOTASK);
	MATCH_AND_RETURN(str, HK_STR_MMAP_FILE, HK_MMAP_FILE);
	MATCH_AND_RETURN(str, HK_STR_MMAP_MUNMAP, HK_MMAP_MUNMAP);
	MATCH_AND_RETURN(str, HK_STR_PTRACE_ACCESS_CHECK, HK_PTRACE_ACCESS_CHECK);
	MATCH_AND_RETURN(str, HK_STR_PTRACE_TRACEME, HK_PTRACE_TRACEME);
	MATCH_AND_RETURN(str, HK_STR_FILE_IOCTL, HK_FILE_IOCTL);
	...
	MATCH_AND_RETURN(str, HK_STR_MSG_QUEUE_MSGSND, HK_MSG_QUEUE_MSGSND);
	MATCH_AND_RETURN(str, HK_STR_MQ_TIMEDSEND, HK_MQ_TIMEDSEND);
	MATCH_AND_RETURN(str, HK_STR_MSG_QUEUE_MSGRCV, HK_MSG_QUEUE_MSGRCV);
	MATCH_AND_RETURN(str, HK_STR_MQ_TIMEDRECEIVE, HK_MQ_TIMEDRECEIVE);
	MATCH_AND_RETURN(str, HK_STR_SHM_ALLOC_SECURITY, HK_SHM_ALLOC_SECURITY);
	MATCH_AND_RETURN(str, HK_STR_SHM_FREE_SECURITY, HK_SHM_FREE_SECURITY);
	MATCH_AND_RETURN(str, HK_STR_SHM_SHMAT, HK_SHM_SHMAT);
	MATCH_AND_RETURN(str, HK_STR_SHM_SHMDT, HK_SHM_SHMDT);
	MATCH_AND_RETURN(str, HK_STR_SK_ALLOC_SECURITY, HK_SK_ALLOC_SECURITY);
	MATCH_AND_RETURN(str, HK_STR_SOCKET_POST_CREATE, HK_SOCKET_POST_CREATE);
	MATCH_AND_RETURN(str, HK_STR_SOCKET_SOCKETPAIR, HK_SOCKET_SOCKETPAIR);
	MATCH_AND_RETURN(str, HK_STR_SOCKET_BIND, HK_SOCKET_BIND);
	MATCH_AND_RETURN(str, HK_STR_SOCKET_CONNECT, HK_SOCKET_CONNECT);
	MATCH_AND_RETURN(str, HK_STR_SOCKET_LISTEN, HK_SOCKET_LISTEN);
	MATCH_AND_RETURN(str, HK_STR_SOCKET_ACCEPT, HK_SOCKET_ACCEPT);
	MATCH_AND_RETURN(str, HK_STR_SOCKET_SENDMSG_ALWAYS, HK_SOCKET_SENDMSG_ALWAYS);
	MATCH_AND_RETURN(str, HK_STR_SOCKET_SENDMSG, HK_SOCKET_SENDMSG);
	MATCH_AND_RETURN(str, HK_STR_SOCKET_RECVMSG_ALWAYS, HK_SOCKET_RECVMSG_ALWAYS);
	MATCH_AND_RETURN(str, HK_STR_SOCKET_RECVMSG, HK_SOCKET_RECVMSG);
	...
	MATCH_AND_RETURN(str, HK_STR_UNIX_MAY_SEND, HK_UNIX_MAY_SEND);
	MATCH_AND_RETURN(str, HK_STR_BPRM_SET_CREDS, HK_BPRM_SET_CREDS);
	...
	MATCH_AND_RETURN(str, HK_STR_SB_ALLOC_SECURITY, HK_SB_ALLOC_SECURITY);
	MATCH_AND_RETURN(str, HK_STR_SB_FREE_SECURITY, HK_SB_FREE_SECURITY);
	MATCH_AND_RETURN(str, HK_STR_SB_KERN_MOUNT, HK_SB_KERN_MOUNT);
	return 0;
}
