...
// incoming packet
static inline void record_pck_to_inode(union prov_msg *pck, union prov_msg *inode)
{
...
// outgoing packet
static inline void record_inode_to_pck(union prov_msg *inode, union prov_msg *pck)
{
	union prov_msg relation;
