...
#define RL_GETXATTR           (RL_USED      | 0x0000000004000000ULL)
#define RL_LSTXATTR           (RL_USED      | 0x0000000008000000ULL)
/* INFORMED SUBTYPES */
...
#define RL_EXEC_PROCESS       (RL_INFORMED  | 0x0000000100000000ULL)
