...
/* INFORMED SUBTYPES */
#define RL_CLONE              (RL_INFORMED  | 0x0000000020000000ULL)
#define RL_VERSION_PROCESS    (RL_INFORMED  | 0x0000000040000000ULL)
#define RL_CHANGE             (RL_INFORMED  | 0x0000000080000000ULL)
#define RL_IFC                (RL_INFORMED  | 0x0000000100000000ULL)
#define RL_EXEC_PROCESS       (RL_INFORMED  | 0x0000000200000000ULL)
