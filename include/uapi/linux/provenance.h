...
/* GENERATED SUBTYPES */
#define RL_CREATE             (RL_GENERATED | 0x0000000000000001ULL)
#define RL_WRITE              (RL_GENERATED | 0x0000000000000002ULL)
#define RL_PERM_WRITE         (RL_GENERATED | 0x0000000000000004ULL)
#define RL_MMAP_WRITE         (RL_GENERATED | 0x0000000000000008ULL)
#define RL_SH_WRITE           (RL_GENERATED | 0x0000000000000010ULL)
#define RL_CONNECT            (RL_GENERATED | 0x0000000000000020ULL)
#define RL_LISTEN             (RL_GENERATED | 0x0000000000000040ULL)
#define RL_BIND               (RL_GENERATED | 0x0000000000000080ULL)
#define RL_SND                (RL_GENERATED | 0x0000000000000100ULL)
#define RL_LINK               (RL_GENERATED | 0x0000000000000200ULL)
#define RL_SETATTR            (RL_GENERATED | 0x0000000000000400ULL)
#define RL_SETXATTR           (RL_GENERATED | 0x0000000000000800ULL)
#define RL_RMVXATTR           (RL_GENERATED | 0x0000000000001000ULL)
/* USED SUBTYPES */
#define RL_READ               (RL_USED      | 0x0000000000000001ULL)
#define RL_MMAP_READ          (RL_USED      | 0x0000000000000002ULL)
#define RL_PERM_READ          (RL_USED      | 0x0000000000000004ULL)
#define RL_SH_READ            (RL_USED      | 0x0000000000000008ULL)
#define RL_EXEC               (RL_USED      | 0x0000000000000010ULL)
#define RL_MMAP_EXEC          (RL_USED      | 0x0000000000000020ULL)
#define RL_PERM_EXEC          (RL_USED      | 0x0000000000000040ULL)
#define RL_ACCEPT             (RL_USED      | 0x0000000000000080ULL)
#define RL_RCV                (RL_USED      | 0x0000000000000100ULL)
#define RL_OPEN               (RL_USED      | 0x0000000000000200ULL)
#define RL_SEARCH             (RL_USED      | 0x0000000000000400ULL)
#define RL_GETATTR            (RL_USED      | 0x0000000000000800ULL)
#define RL_READLINK           (RL_USED      | 0x0000000000001000ULL)
#define RL_GETXATTR           (RL_USED      | 0x0000000000002000ULL)
#define RL_LSTXATTR           (RL_USED      | 0x0000000000004000ULL)
#define RL_NAMED_PROCESS      (RL_USED      | 0x0000000000008000ULL)
#define RL_SAID								(RL_USED      | 0x0000000000010000ULL)
/* INFORMED SUBTYPES */
#define RL_CLONE              (RL_INFORMED  | 0x0000000000000001ULL)
#define RL_VERSION_PROCESS    (RL_INFORMED  | 0x0000000000000002ULL)
#define RL_CHANGE             (RL_INFORMED  | 0x0000000000000004ULL)
#define RL_EXEC_PROCESS       (RL_INFORMED  | 0x0000000000000008ULL)
#define RL_TERMINATE_PROCESS  (RL_INFORMED  | 0x0000000000000010ULL)

/* ACTIVITY SUBTYPES */
#define ACT_TASK              (DM_ACTIVITY  | 0x0000000000000001ULL)
#define ACT_DISC              (DM_ACTIVITY  | 0x0000000000000002ULL)
/* AGENT SUBTYPES */
#define AGT_USR               (DM_AGENT     | 0x0000000000000001ULL)
#define AGT_GRP               (DM_AGENT     | 0x0000000000000002ULL)
#define AGT_DISC              (DM_AGENT     | 0x0000000000000004ULL)
/* ENTITY SUBTYPES */
#define ENT_STR               (DM_ENTITY    | 0x0000000000000001ULL)
#define ENT_INODE_UNKNOWN     (DM_ENTITY    | 0x0000000000000002ULL)
#define ENT_INODE_LINK        (DM_ENTITY    | 0x0000000000000004ULL)
#define ENT_INODE_FILE        (DM_ENTITY    | 0x0000000000000008ULL)
#define ENT_INODE_DIRECTORY   (DM_ENTITY    | 0x0000000000000010ULL)
#define ENT_INODE_CHAR        (DM_ENTITY    | 0x0000000000000020ULL)
#define ENT_INODE_BLOCK       (DM_ENTITY    | 0x0000000000000040ULL)
#define ENT_INODE_FIFO        (DM_ENTITY    | 0x0000000000000080ULL)
#define ENT_INODE_SOCKET      (DM_ENTITY    | 0x0000000000000100ULL)
#define ENT_INODE_MMAP        (DM_ENTITY    | 0x0000000000000200ULL)
#define ENT_MSG               (DM_ENTITY    | 0x0000000000000400ULL)
#define ENT_SHM               (DM_ENTITY    | 0x0000000000000800ULL)
#define ENT_ADDR              (DM_ENTITY    | 0x0000000000001000ULL)
#define ENT_SBLCK             (DM_ENTITY    | 0x0000000000002000ULL)
#define ENT_FILE_NAME         (DM_ENTITY    | 0x0000000000004000ULL)
#define ENT_PACKET            (DM_ENTITY    | 0x0000000000008000ULL)
#define ENT_DISC              (DM_ENTITY    | 0x0000000000010000ULL)
#define ENT_IATTR             (DM_ENTITY    | 0x0000000000020000ULL)
#define ENT_XATTR             (DM_ENTITY    | 0x0000000000040000ULL)
#define ENT_PCKCNT						(DM_ENTITY    | 0x0000000000080000ULL)
