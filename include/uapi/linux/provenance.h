...
/* GENERATED SUBTYPES */
#define RL_CREATE             (RL_GENERATED | 0x0000000000000001ULL<<8)
#define RL_WRITE              (RL_GENERATED | 0x0000000000000001ULL<<9)
#define RL_PERM_WRITE         (RL_GENERATED | 0x0000000000000001ULL<<10)
#define RL_MMAP_WRITE         (RL_GENERATED | 0x0000000000000001ULL<<11)
#define RL_SH_WRITE           (RL_GENERATED | 0x0000000000000001ULL<<12)
#define RL_CONNECT            (RL_GENERATED | 0x0000000000000001ULL<<13)
#define RL_LISTEN             (RL_GENERATED | 0x0000000000000001ULL<<14)
#define RL_BIND               (RL_GENERATED | 0x0000000000000001ULL<<15)
#define RL_SND                (RL_GENERATED | 0x0000000000000001ULL<<16)
#define RL_SND_UNIX           (RL_GENERATED | 0x0000000000000001ULL<<17)
#define RL_LINK               (RL_GENERATED | 0x0000000000000001ULL<<18)
...
/* USED SUBTYPES */
#define RL_READ               (RL_USED      | 0x0000000000000001ULL<<22)
#define RL_MMAP_READ          (RL_USED      | 0x0000000000000001ULL<<23)
#define RL_PERM_READ          (RL_USED      | 0x0000000000000001ULL<<24)
#define RL_SH_READ            (RL_USED      | 0x0000000000000001ULL<<25)
#define RL_EXEC               (RL_USED      | 0x0000000000000001ULL<<26)
#define RL_MMAP_EXEC          (RL_USED      | 0x0000000000000001ULL<<27)
#define RL_PERM_EXEC          (RL_USED      | 0x0000000000000001ULL<<28)
#define RL_ACCEPT             (RL_USED      | 0x0000000000000001ULL<<29)
#define RL_RCV                (RL_USED      | 0x0000000000000001ULL<<30)
#define RL_RCV_UNIX           (RL_USED      | 0x0000000000000001ULL<<31)
#define RL_OPEN               (RL_USED      | 0x0000000000000001ULL<<32)
#define RL_SEARCH             (RL_USED      | 0x0000000000000001ULL<<33)
#define RL_GETATTR            (RL_USED      | 0x0000000000000001ULL<<34)
#define RL_READLINK           (RL_USED      | 0x0000000000000001ULL<<35)
#define RL_GETXATTR           (RL_USED      | 0x0000000000000001ULL<<36)
#define RL_LSTXATTR           (RL_USED      | 0x0000000000000001ULL<<37)
#define RL_NAMED_PROCESS      (RL_USED      | 0x0000000000000001ULL<<38)
#define RL_LOG								(RL_USED      | 0x0000000000000001ULL<<39)
#define RL_ARG								(RL_USED      | 0x0000000000000001ULL<<40)
#define RL_ENV								(RL_USED      | 0x0000000000000001ULL<<41)
/* INFORMED SUBTYPES */
#define RL_CLONE              (RL_INFORMED  | 0x0000000000000001ULL<<42)
#define RL_VERSION_PROCESS    (RL_INFORMED  | 0x0000000000000001ULL<<43)
#define RL_CHANGE             (RL_INFORMED  | 0x0000000000000001ULL<<44)
#define RL_EXEC_PROCESS       (RL_INFORMED  | 0x0000000000000001ULL<<45)
#define RL_TERMINATE_PROCESS  (RL_INFORMED  | 0x0000000000000001ULL<<46)
