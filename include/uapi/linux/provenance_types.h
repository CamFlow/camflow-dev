...
#define RL_WRITE_IOCTL        (RL_GENERATED | (0x0000000000000001ULL<<5))
#define RL_SH_WRITE           (RL_GENERATED | (0x0000000000000001ULL<<6))
...
#define RL_SETATTR            (RL_GENERATED | (0x0000000000000001ULL<<15))
#define RL_SETXATTR           (RL_GENERATED | (0x0000000000000001ULL<<16))
...
#define RL_SH_READ            (RL_USED      | (0x0000000000000001ULL<<3))
#define RL_PROC_READ          (RL_USED    	| (0x0000000000000001ULL<<4))
#define RL_ACCEPT             (RL_USED      | (0x0000000000000001ULL<<5))
#define RL_RCV                (RL_USED      | (0x0000000000000001ULL<<6))
#define RL_RCV_MSG            (RL_USED      | (0x0000000000000001ULL<<7))
#define RL_RCV_MSG_Q          (RL_USED      | (0x0000000000000001ULL<<8))
...
#define RL_ARG                (RL_USED      | (0x0000000000000001ULL<<17))
#define RL_ENV                (RL_USED      | (0x0000000000000001ULL<<18))
