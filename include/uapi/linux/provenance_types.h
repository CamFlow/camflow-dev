...
/* ENTITY SUBTYPES */
#define ENT_STR                                 (DM_ENTITY | ND_LONG | (0x0000000000000001ULL << 6))
...
#define ENT_ADDR                                (DM_ENTITY | ND_LONG | (0x0000000000000001ULL << 17))
#define ENT_SBLCK                               (DM_ENTITY    | (0x0000000000000001ULL << 18))
#define ENT_PATH                                (DM_ENTITY | ND_LONG | (0x0000000000000001ULL << 19))
