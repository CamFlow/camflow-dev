...
#define RL_PERM_WRITE         (RL_GENERATED | (0x0000000000000001ULL<<21))
#define RL_PERM_APPEND        (RL_GENERATED | (0x0000000000000001ULL<<22))
...
#define RL_SH_ATTACH_READ     (RL_USED      | (0x0000000000000001ULL<<19))
// #define RL_SH_ATTACH_WRITE    (RL_USED      | (0x0000000000000001ULL<<22))
#define RL_SH_CREATE_READ     (RL_USED      | (0x0000000000000001ULL<<20))
