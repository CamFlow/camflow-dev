...
#define RL_PERM_READ          (RL_USED      | (0x0000000000000001ULL<<45))
#define RL_PERM_WRITE         (RL_USED      | (0x0000000000000001ULL<<46))
#define RL_PERM_EXEC          (RL_USED      | (0x0000000000000001ULL<<47))
/* INFORMED SUBTYPES */
#define RL_CLONE              (RL_INFORMED  | (0x0000000000000001ULL<<48))
#define RL_VERSION_PROCESS    (RL_INFORMED  | (0x0000000000000001ULL<<49))
#define RL_CHANGE             (RL_INFORMED  | (0x0000000000000001ULL<<50))
#define RL_EXEC_PROCESS       (RL_INFORMED  | (0x0000000000000001ULL<<51))
#define RL_TERMINATE_PROCESS  (RL_INFORMED  | (0x0000000000000001ULL<<52))
