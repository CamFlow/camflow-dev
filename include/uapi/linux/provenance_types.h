...
#define RL_BIND               (RL_GENERATED | (0x0000000000000001ULL<<19))
#define RL_SND                (RL_GENERATED | (0x0000000000000001ULL<<20))
#define RL_SND_UNIX           (RL_GENERATED | (0x0000000000000001ULL<<21))
#define RL_LINK               (RL_GENERATED | (0x0000000000000001ULL<<22))
#define RL_SETATTR            (RL_GENERATED | (0x0000000000000001ULL<<23))
#define RL_SETXATTR           (RL_GENERATED | (0x0000000000000001ULL<<24))
#define RL_RMVXATTR           (RL_GENERATED | (0x0000000000000001ULL<<25))
#define RL_MUNMAP          		(RL_GENERATED | (0x0000000000000001ULL<<26))
#define RL_SHMDT		        		(RL_GENERATED | (0x0000000000000001ULL<<27))
/* USED SUBTYPES */
#define RL_READ               (RL_USED      | (0x0000000000000001ULL<<28))
#define RL_MMAP_READ          (RL_USED      | (0x0000000000000001ULL<<29))
#define RL_SH_READ            (RL_USED      | (0x0000000000000001ULL<<30))
#define RL_EXEC               (RL_USED      | (0x0000000000000001ULL<<31))
#define RL_MMAP_EXEC          (RL_USED      | (0x0000000000000001ULL<<32))
#define RL_ACCEPT             (RL_USED      | (0x0000000000000001ULL<<33))
#define RL_RCV                (RL_USED      | (0x0000000000000001ULL<<34))
#define RL_RCV_UNIX           (RL_USED      | (0x0000000000000001ULL<<35))
#define RL_OPEN               (RL_USED      | (0x0000000000000001ULL<<36))
#define RL_SEARCH             (RL_USED      | (0x0000000000000001ULL<<37))
#define RL_GETATTR            (RL_USED      | (0x0000000000000001ULL<<38))
#define RL_READLINK           (RL_USED      | (0x0000000000000001ULL<<39))
#define RL_GETXATTR           (RL_USED      | (0x0000000000000001ULL<<40))
#define RL_LSTXATTR           (RL_USED      | (0x0000000000000001ULL<<41))
#define RL_NAMED_PROCESS      (RL_USED      | (0x0000000000000001ULL<<42))
#define RL_LOG                (RL_USED      | (0x0000000000000001ULL<<43))
#define RL_ARG                (RL_USED      | (0x0000000000000001ULL<<44))
#define RL_ENV                (RL_USED      | (0x0000000000000001ULL<<45))
#define RL_PERM_READ          (RL_USED      | (0x0000000000000001ULL<<46))
#define RL_PERM_WRITE         (RL_USED      | (0x0000000000000001ULL<<47))
#define RL_PERM_EXEC          (RL_USED      | (0x0000000000000001ULL<<48))
/* INFORMED SUBTYPES */
#define RL_CLONE              (RL_INFORMED  | (0x0000000000000001ULL<<49))
#define RL_VERSION_PROCESS    (RL_INFORMED  | (0x0000000000000001ULL<<50))
#define RL_CHANGE             (RL_INFORMED  | (0x0000000000000001ULL<<51))
#define RL_EXEC_PROCESS       (RL_INFORMED  | (0x0000000000000001ULL<<52))
#define RL_TERMINATE_PROCESS  (RL_INFORMED  | (0x0000000000000001ULL<<53))
