...
#define RL_FILE_LOCK          (RL_GENERATED | (0x0000000000000001ULL<<25))
#define RL_MMAP_WRITE         (RL_GENERATED | (0x0000000000000001ULL<<26))
#define RL_MMAP_READ          (RL_GENERATED | (0x0000000000000001ULL<<27))
#define RL_MMAP_EXEC          (RL_GENERATED | (0x0000000000000001ULL<<28))
...
#define RL_FILE_SIGIO         (RL_USED      | (0x0000000000000001ULL<<10))
#define RL_SEARCH             (RL_USED      | (0x0000000000000001ULL<<11))
#define RL_GETATTR            (RL_USED      | (0x0000000000000001ULL<<12))
#define RL_READ_LINK          (RL_USED      | (0x0000000000000001ULL<<13))
#define RL_GETXATTR           (RL_USED      | (0x0000000000000001ULL<<14))
...
#define RL_SPLICE_IN					(RL_USED 			| (0x0000000000000001ULL<<25))
/* no more than 51!!!! */
