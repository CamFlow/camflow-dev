...
// #define RL_SH_ATTACH_WRITE    (RL_GENERATED | (0x0000000000000001ULL<<21))
// #define RL_SH_CREATE_WRITE    (RL_GENERATED | (0x0000000000000001ULL<<22))
/* no more than 51!!!! */
...
#define RL_SH_CREATE_READ     (RL_USED      | (0x0000000000000001ULL<<23))
