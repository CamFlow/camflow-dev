...
#define RL_PROC_WRITE         (RL_GENERATED | (0x0000000000000001ULL<<4))
#define RL_CONNECT            (RL_GENERATED | (0x0000000000000001ULL<<5))
#define RL_LISTEN             (RL_GENERATED | (0x0000000000000001ULL<<6))
#define RL_BIND               (RL_GENERATED | (0x0000000000000001ULL<<7))
#define RL_SND                (RL_GENERATED | (0x0000000000000001ULL<<8))
#define RL_LINK               (RL_GENERATED | (0x0000000000000001ULL<<9))
#define RL_SETATTR            (RL_GENERATED | (0x0000000000000001ULL<<10))
#define RL_SETXATTR           (RL_GENERATED | (0x0000000000000001ULL<<11))
#define RL_RMVXATTR           (RL_GENERATED | (0x0000000000000001ULL<<12))
#define RL_SHMDT		        	(RL_GENERATED | (0x0000000000000001ULL<<13))
/* no more than 51!!!! */
/* USED SUBTYPES */
...
#define RL_OPEN               (RL_USED      | (0x0000000000000001ULL<<6))
#define RL_SEARCH             (RL_USED      | (0x0000000000000001ULL<<7))
#define RL_GETATTR            (RL_USED      | (0x0000000000000001ULL<<8))
#define RL_READLINK           (RL_USED      | (0x0000000000000001ULL<<9))
#define RL_GETXATTR           (RL_USED      | (0x0000000000000001ULL<<10))
#define RL_LSTXATTR           (RL_USED      | (0x0000000000000001ULL<<11))
#define RL_NAMED_PROCESS      (RL_USED      | (0x0000000000000001ULL<<12))
#define RL_LOG                (RL_USED      | (0x0000000000000001ULL<<13))
#define RL_ARG                (RL_USED      | (0x0000000000000001ULL<<14))
#define RL_ENV                (RL_USED      | (0x0000000000000001ULL<<15))
