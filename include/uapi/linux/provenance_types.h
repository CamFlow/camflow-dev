...
#define RL_SPLICE							(RL_DERIVED   | (0x0000000000000001ULL<<17))
#define RL_EXEC               (RL_DERIVED   | (0x0000000000000001ULL<<18))
#define RL_TERMINATE_PROC     (RL_DERIVED   | (0x0000000000000001ULL<<19))
#define RL_ARG                (RL_DERIVED   | (0x0000000000000001ULL<<20))
#define RL_ENV                (RL_DERIVED   | (0x0000000000000001ULL<<21))
#define RL_SH_READ            (RL_DERIVED   | (0x0000000000000001ULL<<22))
#define RL_SH_WRITE           (RL_DERIVED   | (0x0000000000000001ULL<<23))
#define RL_EXEC_TASK       		(RL_DERIVED   | (0x0000000000000001ULL<<24))
#define RL_PCK_CNT	       		(RL_DERIVED   | (0x0000000000000001ULL<<25))
/* no more than 51!!!! */
...
#define RL_SH_CREATE_READ     (RL_GENERATED | (0x0000000000000001ULL<<23))
#define RL_SH_CREATE_WRITE    (RL_GENERATED | (0x0000000000000001ULL<<24))
/* no more than 51!!!! */
...
#define RL_FILE_LOCK          (RL_USED      | (0x0000000000000001ULL<<10))
#define RL_FILE_SIGIO         (RL_USED      | (0x0000000000000001ULL<<11))
#define RL_SEARCH             (RL_USED      | (0x0000000000000001ULL<<12))
#define RL_GETATTR            (RL_USED      | (0x0000000000000001ULL<<13))
#define RL_READ_LINK          (RL_USED      | (0x0000000000000001ULL<<14))
#define RL_GETXATTR           (RL_USED      | (0x0000000000000001ULL<<15))
#define RL_LSTXATTR           (RL_USED      | (0x0000000000000001ULL<<16))
#define RL_NAMED_PROCESS      (RL_USED      | (0x0000000000000001ULL<<17))
#define RL_LOG                (RL_USED      | (0x0000000000000001ULL<<18))
#define RL_PERM_READ          (RL_USED      | (0x0000000000000001ULL<<19))
#define RL_PERM_WRITE         (RL_USED      | (0x0000000000000001ULL<<20))
#define RL_PERM_EXEC          (RL_USED      | (0x0000000000000001ULL<<21))
#define RL_PERM_APPEND        (RL_USED      | (0x0000000000000001ULL<<22))
#define RL_SH_ATTACH_READ     (RL_USED      | (0x0000000000000001ULL<<23))
#define RL_SH_ATTACH_WRITE    (RL_USED 			| (0x0000000000000001ULL<<24))
/* no more than 51!!!! */
