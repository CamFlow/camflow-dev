...
#define RL_LINK               (RL_GENERATED | (0x0000000000000001ULL<<11))
#define RL_SETATTR            (RL_GENERATED | (0x0000000000000001ULL<<12))
#define RL_SETXATTR           (RL_GENERATED | (0x0000000000000001ULL<<13))
#define RL_RMVXATTR           (RL_GENERATED | (0x0000000000000001ULL<<14))
#define RL_SHMDT		        	(RL_GENERATED | (0x0000000000000001ULL<<15))
/* no more than 51!!!! */
