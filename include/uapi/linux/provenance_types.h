...
#define RL_RCV_PACKET         (RL_DERIVED   | (0x0000000000000001ULL<<8))
#define RL_CLOSED             (RL_DERIVED   | (0x0000000000000001ULL<<9))
#define RL_SETATTR_INODE      (RL_DERIVED   | (0x0000000000000001ULL<<10))
#define RL_ACCEPT_SOCKET      (RL_DERIVED   | (0x0000000000000001ULL<<11))
#define RL_GETXATTR_INODE     (RL_DERIVED   | (0x0000000000000001ULL<<12))
#define RL_SETXATTR_INODE     (RL_DERIVED   | (0x0000000000000001ULL<<13))
#define RL_RMVXATTR_INODE     (RL_DERIVED   | (0x0000000000000001ULL<<14))
#define RL_LINK_INODE         (RL_DERIVED   | (0x0000000000000001ULL<<15))
#define RL_SPLICE							(RL_DERIVED   | (0x0000000000000001ULL<<16))
#define RL_EXEC               (RL_DERIVED   | (0x0000000000000001ULL<<17))
/* no more than 51!!!! */
/* GENERATED SUBTYPES */
#define RL_CREATE             (RL_GENERATED | (0x0000000000000001ULL<<1))
#define RL_WRITE              (RL_GENERATED | (0x0000000000000001ULL<<2))
#define RL_SH_WRITE           (RL_GENERATED | (0x0000000000000001ULL<<3))
#define RL_CONNECT            (RL_GENERATED | (0x0000000000000001ULL<<4))
#define RL_LISTEN             (RL_GENERATED | (0x0000000000000001ULL<<5))
#define RL_BIND               (RL_GENERATED | (0x0000000000000001ULL<<6))
#define RL_SND                (RL_GENERATED | (0x0000000000000001ULL<<7))
#define RL_LINK               (RL_GENERATED | (0x0000000000000001ULL<<8))
#define RL_SETATTR            (RL_GENERATED | (0x0000000000000001ULL<<9))
#define RL_SETXATTR           (RL_GENERATED | (0x0000000000000001ULL<<10))
#define RL_RMVXATTR           (RL_GENERATED | (0x0000000000000001ULL<<11))
#define RL_SHMDT		        	(RL_GENERATED | (0x0000000000000001ULL<<12))
/* no more than 51!!!! */
/* USED SUBTYPES */
#define RL_READ               (RL_USED      | (0x0000000000000001ULL<<1))
#define RL_SH_READ            (RL_USED      | (0x0000000000000001ULL<<2))
#define RL_ACCEPT             (RL_USED      | (0x0000000000000001ULL<<3))
#define RL_RCV                (RL_USED      | (0x0000000000000001ULL<<4))
#define RL_OPEN               (RL_USED      | (0x0000000000000001ULL<<5))
#define RL_SEARCH             (RL_USED      | (0x0000000000000001ULL<<6))
#define RL_GETATTR            (RL_USED      | (0x0000000000000001ULL<<7))
#define RL_READLINK           (RL_USED      | (0x0000000000000001ULL<<8))
#define RL_GETXATTR           (RL_USED      | (0x0000000000000001ULL<<9))
#define RL_LSTXATTR           (RL_USED      | (0x0000000000000001ULL<<10))
#define RL_NAMED_PROCESS      (RL_USED      | (0x0000000000000001ULL<<11))
#define RL_LOG                (RL_USED      | (0x0000000000000001ULL<<12))
#define RL_ARG                (RL_USED      | (0x0000000000000001ULL<<13))
#define RL_ENV                (RL_USED      | (0x0000000000000001ULL<<14))
#define RL_PERM_READ          (RL_USED      | (0x0000000000000001ULL<<15))
#define RL_PERM_WRITE         (RL_USED      | (0x0000000000000001ULL<<16))
#define RL_PERM_EXEC          (RL_USED      | (0x0000000000000001ULL<<17))
/* no more than 51!!!! */
/* INFORMED SUBTYPES */
#define RL_CLONE              (RL_INFORMED  | (0x0000000000000001ULL<<1))
#define RL_VERSION_PROCESS    (RL_INFORMED  | (0x0000000000000001ULL<<2))
#define RL_CHANGE             (RL_INFORMED  | (0x0000000000000001ULL<<3))
#define RL_EXEC_PROCESS       (RL_INFORMED  | (0x0000000000000001ULL<<4))
#define RL_TERMINATE_PROCESS  (RL_INFORMED  | (0x0000000000000001ULL<<5))
/* no more than 51!!!! */
