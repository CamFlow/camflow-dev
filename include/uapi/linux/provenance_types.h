...
#define HK_PTRACE_ACCESS_CHECK                  (RL_HOOK      | (0x0000000000000001ULL<<37))
#define HK_PTRACE_TRACEME                       (RL_HOOK      | (0x0000000000000001ULL<<38))
...
#define prov_is_hook(val)               (prov_is_type(val, RL_HOOK) || prov_is_type(val, RL_HOOK_CONT))
