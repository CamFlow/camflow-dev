...
#define RL_UNLINK                               (RL_GENERATED | (0x0000000000000001ULL << 16))
#define RL_SYMLINK                              (RL_GENERATED | (0x0000000000000001ULL << 17))
...
#define RL_SHMDT                                (RL_GENERATED | (0x0000000000000001ULL << 21))
#define RL_SETUID                               (RL_GENERATED | (0x0000000000000001ULL << 22))
#define RL_SETGID                               (RL_GENERATED | (0x0000000000000001ULL << 23))
#define RL_SH_ATTACH_WRITE                      (RL_GENERATED | (0x0000000000000001ULL << 24))
#define RL_SH_CREATE_READ                       (RL_GENERATED | (0x0000000000000001ULL << 25))
#define RL_SH_CREATE_WRITE                      (RL_GENERATED | (0x0000000000000001ULL << 26))
