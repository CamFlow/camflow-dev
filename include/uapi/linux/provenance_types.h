...
#define RL_WRITE              (RL_GENERATED | (0x0000000000000001ULL<<3))
#define RL_SH_WRITE           (RL_GENERATED | (0x0000000000000001ULL<<4))
#define RL_PROC_WRITE         (RL_GENERATED | (0x0000000000000001ULL<<5))
#define RL_CONNECT            (RL_GENERATED | (0x0000000000000001ULL<<6))
#define RL_LISTEN             (RL_GENERATED | (0x0000000000000001ULL<<7))
#define RL_BIND               (RL_GENERATED | (0x0000000000000001ULL<<8))
#define RL_SND                (RL_GENERATED | (0x0000000000000001ULL<<9))
#define RL_LINK               (RL_GENERATED | (0x0000000000000001ULL<<10))
#define RL_SETATTR            (RL_GENERATED | (0x0000000000000001ULL<<11))
#define RL_SETXATTR           (RL_GENERATED | (0x0000000000000001ULL<<12))
#define RL_RMVXATTR           (RL_GENERATED | (0x0000000000000001ULL<<13))
#define RL_SHMDT		        	(RL_GENERATED | (0x0000000000000001ULL<<14))
/* no more than 51!!!! */
