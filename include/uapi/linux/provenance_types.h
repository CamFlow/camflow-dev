...
#define RL_INODE_CREATE      	(RL_GENERATED | (0x0000000000000001ULL<<3))
...
#define RL_UNLINK             (RL_GENERATED | (0x0000000000000001ULL<<14))
#define RL_SYMLINK            (RL_GENERATED | (0x0000000000000001ULL<<15))
...
#define RL_SH_CREATE_READ     (RL_GENERATED | (0x0000000000000001ULL<<22))
#define RL_SH_CREATE_WRITE    (RL_GENERATED | (0x0000000000000001ULL<<23))
#define RL_FILE_LOCK          (RL_GENERATED | (0x0000000000000001ULL<<24))
#define RL_MMAP_WRITE         (RL_GENERATED | (0x0000000000000001ULL<<25))
#define RL_MMAP_READ          (RL_GENERATED | (0x0000000000000001ULL<<26))
#define RL_MMAP_EXEC          (RL_GENERATED | (0x0000000000000001ULL<<27))
...
#define RL_GETGID             (RL_USED 			| (0x0000000000000001ULL<<23))
