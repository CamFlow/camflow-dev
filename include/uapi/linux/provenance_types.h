...
#define RL_SH_WRITE           (RL_GENERATED | (0x0000000000000001ULL<<7))
#define RL_PROC_WRITE         (RL_GENERATED | (0x0000000000000001ULL<<8))
#define RL_CONNECT            (RL_GENERATED | (0x0000000000000001ULL<<9))
...
#define RL_FILE_RCV           (RL_USED      | (0x0000000000000001ULL<<10))
