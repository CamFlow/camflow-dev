...
/* DERIVED SUBTYPES */
#define RL_VERSION                              (RL_DERIVED   | (0x0000000000000001ULL))
#define RL_SND_PACKET                           (RL_DERIVED   | (0x0000000000000001ULL << 1))
#define RL_SND_UNIX                             (RL_DERIVED   | (0x0000000000000001ULL << 2))
#define RL_RCV_PACKET                           (RL_DERIVED   | (0x0000000000000001ULL << 3))
#define RL_RCV_UNIX                             (RL_DERIVED   | (0x0000000000000001ULL << 4))
#define RL_FREED                                (RL_DERIVED   | (0x0000000000000001ULL << 5))
...
#define RL_EXEC                                 (RL_DERIVED   | (0x0000000000000001ULL << 11))
#define RL_TERMINATE_PROC                       (RL_DERIVED   | (0x0000000000000001ULL << 12))
#define RL_ARG                                  (RL_DERIVED   | (0x0000000000000001ULL << 13))
#define RL_ENV                                  (RL_DERIVED   | (0x0000000000000001ULL << 14))
#define RL_SH_READ                              (RL_DERIVED   | (0x0000000000000001ULL << 15))
#define RL_SH_WRITE                             (RL_DERIVED   | (0x0000000000000001ULL << 16))
#define RL_PCK_CNT                              (RL_DERIVED   | (0x0000000000000001ULL << 17))
#define RL_ADDRESSED                            (RL_DERIVED   | (0x0000000000000001ULL << 18))
#define RL_DERIVED_DISC                         (RL_DERIVED   | (0x0000000000000001ULL << 19))
/* no more than 51!!!! */
